...
If you want to run the full RAT workflow, RAT needs all CAT dependencies to be available. RAT further requires:

BWA, https://github.com/lh3/bwa.

samtools, http://www.htslib.org/download/.

RAT has been tested with samtools 1.10 and 1.11.
