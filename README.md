...
Since version 4.1 CAT and BAT leave much less footprints: the size of the alignment output files is greatly reduced, and alignment is up to 3 times faster compared to previous releases. Version 4.2 focused on streamlining of code.
...
```
$ CAT contigs --r 5 --f 0.1 -c contigs.fasta -d CAT_database/ -t CAT_taxonomy/ -p first_CAT_run.predicted_proteins.fasta -a first_CAT_run.alignment.diamond -o second_CAT_run
