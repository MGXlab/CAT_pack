...
Since version 4.1 CAT and BAT leave much less footprints: the size of the alignment output files is greatly reduced, and alignment is up to 3 times faster.
